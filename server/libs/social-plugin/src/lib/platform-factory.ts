...
export class PlatformFactory {
   ...
   */
  static createPlatform(type: PlatformType, config: SocialPlatformConfig, logger: ReturnType<typeof Logger>): SocialCore {
   ...
   */
  static createPlatforms(config: PlatformConfig, logger: ReturnType<typeof Logger>): Map<PlatformType, SocialCore> {
